# ELEMENTOS DEL DESARRROLLO DE SOFTWARE
...
CPU no puede leer del disco, solo del memoria RAM. Las instrucciones están en codigo binario.
...
Codigo objeto está destinado al procesador nativo, execpto el bytcode de java que está destinada la Máquina Virtual Java(MVJ).
...
![Modelo en cascada](imagenes/cascada.png)
...
![Modelo de construcción de prototipos](imagenes/prototipos.png)
...
![Modelo en espiral](imagenes/espiral.png)
...
![Modelo en espiral](imagenes/espiral-poo.png)
...
![Pizarra kanban](imagenes/kanban-board.png)
...
![Proceso SCRUM](imagenes/scrum.png)
...
- Para obtener código binario ejecutable tenemos 2 opciones:
  - __Compilar__ Genera un archivo
  - __Interpretar__ No genera nignún archivo


### Proceso de compilación/interpretación

- La compilación/interpretación del código fuente se lleva a cabo en dos fases:
  1. __Análisis léxico__ Equivale a la ortografía
  2. __Análisis sintáctico__ Equivale a la gramática
...
-Ejemplo: 
         - int x=0;
         - if (x=0);
         System.out.println("Valor 0 en x");
...
- Ejemplos: PHP, Javascript, Javascript produce un "codigo objeto" llamado .class que esta destinado a la maquina virtual de java
- Principal ventaja: El código fuente se interpreta directamente.
- Principal desventaja: Ejecución menos eficiente y mas lentos que los lenguajes compilados.
...
- Normalmente son lenguajes interpretados."Poco uso, excepto SQL"
...
- Muchos de estos lenguajes son compilados. Ej: C,C++ y Javascript es medio compilado.
...
- Tipos de lenguajes según nivel de abstracción: 
  - Bajo nivel: ensamblador. Utiliza una palabra memotecnica como por ej:sum.
  - Medio nivel: C
  - Alto nivel: C++, Java.
